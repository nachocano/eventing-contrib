...
import (
	...
	v1alpha1 "knative.dev/eventing-contrib/container/pkg/apis/sources/v1alpha1"
)
...
var containersourcesResource = schema.GroupVersionResource{Group: "sources", Version: "v1alpha1", Resource: "containersources"}

var containersourcesKind = schema.GroupVersionKind{Group: "sources", Version: "v1alpha1", Kind: "ContainerSource"}
